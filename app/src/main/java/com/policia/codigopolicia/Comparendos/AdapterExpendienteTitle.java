...
public class AdapterExpendienteTitle extends BaseExpandableListAdapter {

    private Fragment fragment;
    private ArrayList<DetalleExpediente> expedientes;

    public AdapterExpendienteTitle(Fragment fragment, RNMCGENERALResponse expediente) {

        this.fragment = fragment;

        expedientes = new ArrayList<>();
        for (RNMCGENERALResult comportamiento : expediente.rNMCGENERALResult) {
            expedientes.add(new DetalleExpediente(comportamiento));
        }
    }
