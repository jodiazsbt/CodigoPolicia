...
import com.policia.negocio.logica.Negocio_TITULO_MULTA;
...
public class Nivel_BaseExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<Modelo_MULTA> libros;
    private ArrayList<Detalle_TITULO> titulos;

    private Negocio_TITULO_MULTA negocio_titulo;

    public Nivel_BaseExpandableListAdapter(Fragment context, ArrayList<Modelo_MULTA> libros) {
        ...
        try {
            negocio_titulo = new Negocio_TITULO_MULTA(context.getContext());

            for (Modelo_MULTA libro : libros) {
